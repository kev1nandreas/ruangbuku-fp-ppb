...
class BorrowModel {
  ...
  factory BorrowModel.fromJson(Map<String, dynamic> json) {
    ...
    return BorrowModel(
      ...
      bookTitle: book['title']?.toString() ?? 'Unknown',
      bookAuthor: book['author']?.toString() ?? 'Unknown',
      bookImageUrl: book['coverImageUrl']?.toString() ?? 'https://picsum.photos/200/300',
      borrowerId: json['user_id']?.toString() ?? '',
      borrowerName: json['user']?['name']?.toString() ?? 'Unknown',
